...
eq "guard: category globs MISS a real dir (the fail-open bug)" "$(bus_manual_pattern_match /home/x/workspace/pct && echo y || echo n)" n
printf '*pct*\n' > "$CLAUDEMUX_ROOT/manual-patterns"
eq "guard: a real-name glob COVERS the dir"                    "$(bus_manual_pattern_match /home/x/workspace/pct && echo y || echo n)" y
...
pk=$(mksess "ffffffff-1111-1111-1111-111111111111" "pctsess" "/home/x/workspace/pct")
"$R/bus-register.sh" --pid "$pk" --cwd /home/x/workspace/pct --mode manual >/dev/null
